Namespace MultiGroupSummary
    Partial Public Class Form1
        ...
        Private Sub InitializeComponent()
            ...
            Me.myGridView1.GroupSummary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() { _
                New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Min, "Data", Me.colData, "Min data = {0}"), _
                New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Max, "Data", Me.colData, "Max data = {0}"), _
                New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Data", Me.colData, "Count data = {0}"), _
                New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Min, "Int", Me.colInt, "Min int = {0}"), _
                New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Max, "Int", Me.colInt, "Max int = {0}"), _
                New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Average, "Int", Me.colInt, "Avg int = {0}"), _
                New DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "Int", Me.colInt, "Sum int = {0}") _
            })
