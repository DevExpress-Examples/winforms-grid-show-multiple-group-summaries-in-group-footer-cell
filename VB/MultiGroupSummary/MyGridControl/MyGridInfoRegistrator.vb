...
Namespace Q354185.MyXtraGrid
    ...
    Public Class MyGridInfoRegistrator
        ...
        Public Overrides Function CreateViewInfo(ByVal view As BaseView) As Views.Base.ViewInfo.BaseViewInfo
        ...
        Public Overrides Function CreateHandler(ByVal view As BaseView) As Views.Base.Handler.BaseViewHandler
